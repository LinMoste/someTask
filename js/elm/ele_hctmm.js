...
async function pageview(_0x4ee77b, _0x3c1018, _0x92595d, _0x1b4697) {
    ...
    var _0x4c1b86 = "data=" + encodeURIComponent(JSON.stringify(_0x5dc5ba));
    const _0x4a8da5 = getToken(_0x4ee77b),
        _0x1c1413 = _0x4a8da5.split("_")[0];
    const _0x537a00 = await sign(_0x1c1413 + "&" + _0x1302e2 + "&" + _0x42f860 + "&" + JSON.stringify(_0x5dc5ba), kami);
    var _0x10b5f2 = {
    ...
    return tryCatchPromise(_0x74629e => {
        request(_0x10b5f2, async (_0x5276b3, _0x44dd3f, _0x1b4ea3) => {
...
async function query_task(_0x2df94c, _0x10c298) {
    ...
    return tryCatchPromise(_0x417ea5 => {
        request(_0x22cdd3, async (_0x3be239, _0x17e935, _0x4f33d9) => {
...
async function receive_sign_prize(_0x4011fd, _0xafb123, _0x18306f, _0x28e046, _0x5b5939, _0x19b581, _0x5b96fb) {
    ...
    var _0x2cfe00 = "data=" + encodeURIComponent(JSON.stringify(_0x5a5c80));
    const _0x154946 = getToken(_0x4011fd),
        _0x1aada7 = _0x154946.split("_")[0];
    const _0x4cc348 = await sign(_0x1aada7 + "&" + _0x5a41ec + "&" + _0x1b5d84 + "&" + JSON.stringify(_0x5a5c80), kami);
    var _0x473294 = {
    ...
    return tryCatchPromise(_0x1fb635 => {
        request(_0x473294, async (_0x5f44bb, _0x8d7d42, _0x2ee184) => {
...
async function receive_prize(_0x22e770, _0x3f72cb, _0x5f2375, _0x4c57bd, _0xdbd562, _0x13622e, _0x44b7a2) {
    ...
    var _0x2823bb = "data=" + encodeURIComponent(JSON.stringify(_0x3a99cb));
    const _0x4303af = getToken(_0x22e770),
        _0x232f46 = _0x4303af.split("_")[0];
    const _0x6f27c2 = await sign(_0x232f46 + "&" + _0x3a4c4f + "&" + _0x201157 + "&" + JSON.stringify(_0x3a99cb), kami);
    var _0x503de0 = {
    ...
    return tryCatchPromise(_0x86da96 => {
        request(_0x503de0, async (_0x2e659c, _0x2e418a, _0x4cdeb4) => {
...
async function receive_offline_task(_0x30262c, _0x2dd85b, _0x79ef3c) {
    ...
    var _0x2e7b52 = "data=" + encodeURIComponent(JSON.stringify(_0x351d1d));
    const _0xad3aa6 = getToken(_0x30262c),
        _0x16c5fb = _0xad3aa6.split("_")[0];
    const _0x19e6f8 = await sign(_0x16c5fb + "&" + _0x1d7aa9 + "&" + _0x4d603a + "&" + JSON.stringify(_0x351d1d), kami);
    var _0x546185 = {
    ...
    return tryCatchPromise(_0x4db782 => {
        request(_0x546185, async (_0x5299e5, _0x34ac26, _0x58a721) => {
...
async function receive_task(_0x10bce8, _0x454092, _0x278cf4) {
    ...
    var _0x2b179d = "data=" + encodeURIComponent(JSON.stringify(_0x392b41));
    const _0x4f1842 = getToken(_0x10bce8),
        _0x149751 = _0x4f1842.split("_")[0];
    const _0x1bb756 = await sign(_0x149751 + "&" + _0x374761 + "&" + _0x35b61e + "&" + JSON.stringify(_0x392b41), kami);
    var _0x5014c9 = {
    ...
    return tryCatchPromise(_0x1e6956 => {
        request(_0x5014c9, async (_0x43d440, _0x2ea4c9, _0x590a6a) => {
...
async function gameRequest(_0x2d6a6f, _0x27d2aa) {
    ...
    return new Promise(_0x527dc9 => {
        request(_0x30f489, async (_0x43ffe9, _0x242de8, _0x23a909) => {
...
async function getGameInfo(_0x26bee2) {
    ...
    const _0x27141a = await gameRequest(_0x26bee2, _0xa5fd45);
...
async function dataSynchronism(_0x4153dc, _0x5c6349, _0x437b85, _0x4ada95) {
    ...
    const _0x985bac = await gameRequest(_0x4153dc, _0x4efc01);
...
async function finishOrder(_0x437349, _0x29238b, _0x3aba6a, _0x16c5c0, _0x231775, _0xecedd3) {
    ...
    const _0x33c5a7 = await gameRequest(_0x437349, _0x3bbc02);
...
async function getOrders(_0x46b978, _0x249465, _0x1eb028) {
    ...
    const _0x40b5a7 = await gameRequest(_0x46b978, _0x1683b4);
...
async function offlineReward(_0x2224ab, _0x443c7f, _0x3f57ba) {
    ...
    let _0xefbf2f = await query_task(_0x2224ab, _0x250012);
    ...
    _0xefbf2f = await query_task(_0x2224ab, _0x250012);
...
async function signinReward(_0x2bb91b, _0x3baa70, _0x4d25ec, _0x439305) {
    ...
    let _0x3fde09 = await query_task(_0x2bb91b, _0x5163cf);
    ...
    _0x3fde09 = await query_task(_0x2bb91b, _0x5163cf);
    ...
    return await gameRequest(_0x2bb91b, _0x3c1767);
}
async function buyFood(_0x51e17b, _0x4ad5ef, _0x4ba6b2, _0x3d7f5f, _0x2589ba) {
    ...
    return await gameRequest(_0x51e17b, _0xe390cc);
}
